...
class BeastDealsMalePageView extends StatefulWidget {
  const BeastDealsMalePageView({Key? key}) : super(key: key);

  @override
  State<BeastDealsMalePageView> createState() => _BeastDealsMalePageViewState();
}

class _BeastDealsMalePageViewState extends State<BeastDealsMalePageView> {
      ...
      body: Consumer<AllDealsNotifier>(
        builder: (_, notifier, child) {
          return ListView.builder(
              itemCount: notifier.allDealsModel.bestDealsMen?.length,
              itemBuilder: (_, index) {
                DealsModel obj = notifier.allDealsModel.bestDealsMen![index];
                return Container(
                  height: 0.21.sh,
