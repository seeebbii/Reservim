...
import '../../../../../../core/model/appointment/book_appointment.model.dart';

class BestDealsWomenPageView extends StatefulWidget {
  const BestDealsWomenPageView({Key? key}) : super(key: key);

  @override
  State<BestDealsWomenPageView> createState() => _BestDealsWomenPageViewState();
}

class _BestDealsWomenPageViewState extends State<BestDealsWomenPageView> {
      ...
      body: Consumer<AllDealsNotifier>(
        builder: (_, notifier, child) {
          return ListView.builder(
              itemCount: notifier.allDealsModel.bestDealsWomen?.length,
              itemBuilder: (_, index) {
                DealsModel obj = notifier.allDealsModel.bestDealsWomen![index];
                return Container(
                  height: 0.21.sh,
