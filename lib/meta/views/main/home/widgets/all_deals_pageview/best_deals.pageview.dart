...
import '../deals_categories.widget.dart';

class BestDealsPageView extends StatefulWidget {
  const BestDealsPageView({Key? key}) : super(key: key);

  @override
  State<BestDealsPageView> createState() => _BestDealsPageViewState();
}

class _BestDealsPageViewState extends State<BestDealsPageView> {
      ...
      body: Consumer<AllDealsNotifier>(
        builder: (_, notifier, child) {
          return ListView.builder(
              itemCount: notifier.allDealsModel.bestDeals?.length,
              itemBuilder: (_, index) {
                DealsModel obj = notifier.allDealsModel.bestDeals![index];
