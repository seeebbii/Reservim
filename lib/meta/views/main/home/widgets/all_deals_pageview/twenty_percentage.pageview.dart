...
class TwentyPercentagePageView extends StatefulWidget {
  const TwentyPercentagePageView({Key? key}) : super(key: key);

  @override
  State<TwentyPercentagePageView> createState() =>
      _TwentyPercentagePageViewState();
}

class _TwentyPercentagePageViewState extends State<TwentyPercentagePageView> {
      ...
      body: Consumer<AllDealsNotifier>(
        builder: (_, notifier, child) {
          return ListView.builder(
              itemCount: notifier.allDealsModel.twentyPercentDeals?.length,
              itemBuilder: (_, index) {
                DealsModel obj =
                    notifier.allDealsModel.twentyPercentDeals![index];
                return Container(
                  height: 0.21.sh,
